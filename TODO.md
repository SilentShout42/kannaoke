...
In the future I'll get members streams annotated with metadata indicating that they're from members VODs, so they can be excluded from random song results and maybe get some special icon in the song list.
